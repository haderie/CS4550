...
export default function Profile() {
  return (
    <div id="wd-profile-screen">
      ...
      />
      <input id="wd-firstname" value="Alice" placeholder="First Name" className="form-control mb-2"/>      <input id="wd-lastname" value="Wonderland" placeholder="Last Name" className="form-control mb-2" />
      ...
      <Link to="/Kanbas/Account/Signin" className="btn btn-primary w-100 btn-danger">Sign out</Link>
    </div>
  );
}